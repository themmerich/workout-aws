...
# ECR Lifecycle Policy — alte Images automatisch löschen
resource "aws_ecr_lifecycle_policy" "main" {
  ...
  policy = jsonencode({
    rules = [{
      rulePriority = 1
      description  = "Nur die letzten 5 Images behalten"
      selection = {
        tagStatus   = "any"
...
# CloudWatch Log Group für ECS Logs
...
# IAM Role für ECS Task Execution
